<template>
  <div class="forgetPass">
    <van-nav-bar title="修改交易密码" left-arrow fixed :placeholder="true" @click-left="onClickLeft" />
    <div class="forgetPass_form">
      <div>
        <div>
          <van-field v-model="form.password2" type="digit" placeholder="请输入新交易密码" maxlength="6"/>
        </div>
        <!-- <div>
          <i :class="
      ...
      <div>
        <div>
          <van-field v-model="affNewPassword" type="digit" placeholder="再次输入新交易密码" maxlength="6"/>
        </div>
        <!-- <div>
          <i :class="
      ...
      <van-button @click="confirm" round type="primary">确认修改</van-button>
    </div>
  </div>
</template>
...
.forgetPass input::-webkit-input-placeholder {
